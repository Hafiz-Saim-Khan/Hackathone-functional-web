...
//       <div className="text-center">
//         <h1 className="text-lg font-semibold mb-4">Hello Nike App</h1>
//         <div className="grid sm:flex md:flex lg:flex justify-center gap-4 sm:ml-[100px] xl:ml-[450px] md:ml-[200px] lg:ml-[300px]">
//           <p className="text-md font-medium mb-3">Download the app to access everything Nike.</p>
//           <p className="underline cursor-pointer font-semibold">Get Your Great</p>
//         </div>
//         <section className="mt-10">
//           <Image
//             src="/nike-shoes.png"
...
//       {/* PART 2 OF HOME PAGE */}
//       <div className="h-[229px] ml-3 lg:w-[800px] xl:w-[1008px] sm:text-center md:text-center xl:text-center flex-wrap xl:ml-28 lg:ml-28 mb-[100px]">
//         <h3 className="font-semibold sm:ml-[50px] ml-28 text-[15px]">First Look</h3>
//         <h1 className="font-semibold text-4xl sm:text-[56px] md:text-[56px] lg:text-[56px] xl:text-[56px] ml-0">
//           NIKE AIR MAX PULSE
//         </h1>
...
//           <button className="h-[39px] w-[110px] bg-black text-white rounded-full">Notify Me</button>
//           <button className="h-[39px] w-[148px] bg-black text-white rounded-full">Shop Air Max</button>
//         </section>
//       </div>
...
//           {/* IMAGE 1 */}
//           <div className="w-full sm:w-[300px] lg:w-[350px] xl:w-[341px] border-2 bg-gray-50">
//             <Image
...
//               <h3 className="font-semibold text-[15px]">Nike Air Max Pulse</h3>
//               <p className="font-semibold">13 995</p>
//             </div>
//             <p className="text-[#757575] text-sm px-4">Women's shoes</p>
//           </div>
...
//               <p className="font-semibold">13 995</p>
//             </div>
//             <p className="text-[#757575] text-sm px-4">Men's shoes</p>
//           </div>
...
//             />
//             <div className="flex justify-between px-4 py-2">
//               <h3 className="font-semibold text-[15px]">Nike Air Max 97 SE</h3>
...
//       {/* PART 4 OF HOME PAGE */}
//       <div className="p-5 mt-20 mb-20">
//         <h2 className="font-semibold text-[22px]">Featured</h2>
//         <Image
...
//           <h1 className="font-semibold text-3xl lg:text-[54px]">STEP INTO WHAT FEELS GOOD</h1>
//           <p className="text-[15px]">Cause everyone should know the feeling of running in that perfect pair.</p>
//           <button className="h-[39px] w-[160px] bg-black text-white rounded-full mt-8">Find Your Shoe</button>
//         </section>
//       </div>

//       {/* PART 5 - Gear Up */}
//       <h1 className="font-semibold text-[23px] p-5">Gear Up</h1>
//       <div className="flex flex-wrap justify-center items-center gap-5 p-5">
//         {/* Section 1 */}
//         <div className="w-full sm:w-[300px] md:w-[350px]  px-10 lg:w-[400px] xl:w-[400px]">
//           <Image
//             src="/tea-shirt-1.png"
...
//             layout="responsive"
//           />
//           <h2 className="mt-5">Nike Dri FIT ADV TechKnit Ultra</h2>
//           <p className="text-[#757575] text-[16px] mt-2">Men's Short Sleeve Running Top</p>
//           <p className="font-semibold">3 895</p>
//         </div>

//         {/* Section 2 */}
//         <div className="w-full sm:w-[300px] px-10 md:w-[350px] lg:w-[400px] xl:w-[400px] 2xl:[300px]">
//           <Image
//             src="/chadda.png"
...
//             layout="responsive"
//           />
//           <h2 className="mt-5">Nike Dri FIT Challenger</h2>
//           <p className="text-[#757575] text-[16px] mt-2">Men's Versatile Shorts</p>
...
//       {/* PART 6 - Don't Miss */}
//       <div className="p-5">
//         <h1 className="font-semibold text-[22px]">Don't Miss</h1>
//         <Image
//           className="h-80 w-80 mt-5"
//           src="/part-4-img.png"
//           alt="Don't Miss"
...
//       {/* PART 7 - Flight Essentials */}
//       <div className="text-center mb-10">
//         <h1 className="font-semibold text-[54px]">FLIGHT ESSENTIALS</h1>
//         <p className="text-[15px]">Your built-to-last, all week wears—but with style only Jordan brand can deliver.</p>
//         <button className="h-[39px] w-[80px] bg-black text-white text-[15px] rounded-full mt-9">Shop</button>
//       </div>
