...
// // Page Component using getServerSideProps (for fetching data server-side)
// export async function getServerSideProps({ params }: { params: { id: string } }) {
//   const product = await getProductData(params.id);

//   if (!product) {
//     return { notFound: true };  // If no product found, return 404
//   }

//   return {
//     props: { product },  // Pass the product data as a prop
//   };
// }

// // Page component
// export default function ProductPage({ product }: { product: Hackathone }) {
//   if (!product) {
//     return notFound(); // If no product found, show 404
//   }
